...
//import com.zhkj.log.Lo
import com.zhkj.log.Log;
import com.zhkj.tools.EditTools;
import com.zhkj.tools.ModeRule;
import com.zhkj.tools.ParseModule;
...
//                Log.appendErr("info："+str);
                //关键字|SpecialKey=Loader,Handler,i,View,Dialog
                if(str.contains("关键字")){
                    String[] arr = str.split("=");
                    String[] arr2 = arr[1].split(",");
                    EditTools.setSpecialKey(arr2);//获取得到关键字
                }
                //标题
                if(str.contains("标题")){
                    String[] arr=str.split("\\|");

...
/**
 * 数据库管理类
 * 主键设置成自增长：replace():插入数据、更新数据的效果。saveOrUpdate():插入数据的效果
 * 主键设置成不是自增长：replace():插入数据的效果。saveOrUpdate()插入数据、更新数据的效果。注意：更新的时候主键要对应的上
 * @author: FYL
 * @time: 2018/9/3
...
public class DBManager {
    ...
    private static String DBNAME = "rdframework.db";//默认数据库名称
